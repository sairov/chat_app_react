    ...
    io.on('connection', (socket) => {
        ...
        socket.on('join', async (user) => {
            ...
            if (users.has(user.id)) {
                ...
                existingUser.sockets = [...existingUser.sockets, ...[sockets.id]]
                users.set(user.id, existingUser)
                sockets = [...existingUser.sockets, ...[sockets.id]]
            ...
            // send to user sockets which of hos friends are online
        ...
        socket.on('add-user-to-group', ({chat, newChatter}) => {
            ...
            // send to new chatter
            if (users.has(newChatter.id)) {
                users.has(newChatter.id).sockets.forEach(socket => {
